...
def write_index_readme(run_dir, context):
    ...
    lines = [
        ...
        "",
        f"Current coverage is {compact_count(cases_per_model_run)} scored cases per model run. The fixture target includes 112 deterministic pair cases, 30 triage cases, 8 extraction cases, 8 policy-check cases, one exported user-suite correction, row-watch checks, and semantic checks",
        "",
