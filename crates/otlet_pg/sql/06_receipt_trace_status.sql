...
SELECT
  ...
  r.trace_summary ->> 'semantic_program_name' AS semantic_program_name,
  r.trace_summary ->> 'semantic_program_hash' AS semantic_program_hash,
  r.trace_summary ->> 'semantic_program_predicate' AS semantic_program_predicate,
