...
SELECT
  ...
  s.runtime_name,
  s.prompt_tokens,
  s.prompt_cached_tokens_before,
  s.prompt_reused_tokens,
  s.prompt_decoded_tokens,
  s.prompt_reuse_strategy,
  s.prompt_prefix_state_bytes,
  s.prompt_prefix_cache_entries,
  s.prompt_prefix_cache_bytes,
  ...
  s.runtime_fingerprint_hash,
  s.runtime_output_contract_hash,
  s.runtime_fingerprint,
