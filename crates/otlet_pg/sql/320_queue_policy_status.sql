...
SELECT
  ...
  p.health_max_queued_jobs,
  p.health_max_worker_rss_bytes,
  p.health_max_connections,
  p.health_max_database_bytes,
  p.health_max_wal_bytes_since_reset,
  p.health_max_otlet_storage_bytes,
  p.health_require_autovacuum,
  p.health_max_application_latency_ms,
  p.health_application_latency_max_age,
