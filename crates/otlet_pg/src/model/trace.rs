fn generation_trace_summary(
    ...
    let summary = json!({
        ...
        "runtime_prepare_ms": metrics.runtime_prepare_ms,
        "model_load_ms": if metrics.cache_hit { 0 } else { metrics.load_ms },
        "model_context_ms": if metrics.cache_hit { 0 } else { metrics.ctx_ms },
