...
struct OtletSemanticCustomScanState {
    ...
    planner_preload_estimated_rows: u64,
    planner_preload_estimated_bytes: u64,
    planner_preload_estimated_ms: u64,
    planner_preload_estimate_basis: *mut c_char,
    preload_max_rows: u64,
    preload_max_bytes: u64,
    preload_max_ms: u64,
    actual_preload_rows: u64,
    actual_preload_bytes: u64,
    actual_preload_ms: u64,
    rows_seen: u64,
    rows_returned: u64,
    lookup_rows: u64,
...
struct RuntimeState {
    ...
    planner_preload_estimated_bytes: u64,
    planner_preload_estimated_ms: u64,
    planner_preload_estimate_basis: String,
    preload_max_rows: u64,
    preload_max_bytes: u64,
    preload_max_ms: u64,
    actual_preload_rows: u64,
...
struct SemanticPlannerStats {
    ...
    stale_reasons: String,
    count_basis: String,
    preload_estimated_rows: u64,
    preload_estimated_bytes: u64,
    preload_estimated_ms: u64,
    preload_estimate_basis: String,
    preload_max_rows: u64,
    preload_max_bytes: u64,
    preload_max_ms: u64,
}
