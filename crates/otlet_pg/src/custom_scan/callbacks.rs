...
unsafe extern "C-unwind" fn begin_semantic_custom_scan(
    ...
    unsafe {
        ...
        (*state).runtime = Box::into_raw(Box::new(RuntimeState {
            ...
            program_name: private.program_name,
            program_hash: private.program_hash,
            program_predicate: private.program_predicate,
            program_compiler_mode: private.program_compiler_mode,
