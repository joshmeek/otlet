...
| Stable failure and retry taxonomy | Assign versioned reason code, stage, retryability, owner action, and raw-detail visibility across SQL, native, and portable paths while leaving automated quarantine conditional. Reuse the application retry lineage and mode |
